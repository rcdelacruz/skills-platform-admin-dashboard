    ...
    recommendations: [
      {
        ...
        targetLevel: 5,
        description:
          "Master advanced Selenium techniques for robust and efficient automated testing.",
      },
      {
        ...
        targetLevel: 4,
        description:
          "Learn to create, run, and analyze performance tests using Apache JMeter.",
      },
    ],
  },
  {
    ...
    recommendations: [
      {
        ...
        targetLevel: 4,
        description:
          "Learn to effectively test RESTful APIs using Postman and write automated API tests.",
      },
      {
        skill: "Test Planning",
        ...
        targetLevel: 5,
        description:
          "Master the art of test planning and management in Agile environments.",
      },
    ],
  },
  {
    ...
    recommendations: [
      {
        ...
        targetLevel: 4,
        description:
          "Comprehensive course on identifying and testing for common web application security vulnerabilities.",
      },
    ],
  },
];
...
export default function ManagerDashboard() {
  ...
  const averageTeamPerformance = Math.round(
    teamPerformance[teamPerformance.length - 1].performance,
  );
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <div className="grid gap-4 md:grid-cols-2 mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Distribution of roles in your team
                </CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <TabsContent value="performance">
          ...
          <Card className="mt-4">
            <CardHeader>
              ...
              <CardDescription>
                Performance scores of team members
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ScrollArea className="h-[300px]">
        ...
        <TabsContent value="skills">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Overview of skills across experience levels
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={400}>
          ...
          <Card className="mt-4">
            <CardHeader>
              ...
              <CardDescription>
                Detailed view of individual skills
              </CardDescription>
            </CardHeader>
            <CardContent>
              <ScrollArea className="h-[300px]">
                  ...
                  {trainingRecommendations.map((member, index) => (
                    ...
                    >
                      ...
                      {member.recommendations.length > 0 ? (
                        ...
                        <p className="text-muted-foreground">
                          No specific training recommendations at this time.
                        </p>
                      )}
                    </div>
                  ))}
        ...
        <TabsContent value="evaluation">
          <Card>
            ...
            <CardContent>
              <p className="mb-4">
                Select a team member to start their performance evaluation:
              </p>
              <Select>
                ...
                <SelectContent>
                  {topPerformers.map((member, index) => (
                    <SelectItem
                      key={index}
                      value={member.name.toLowerCase().replace(" ", "-")}
                    >
                      {member.name}
                    </SelectItem>
                  ))}
